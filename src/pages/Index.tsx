...
const Index = () => {
  ...
  return (
    <div className="min-h-screen py-8 px-4 pb-24 relative">
        ...
        <div className="text-center space-y-4">
          <div className="flex justify-center mb-6">
            <img
              src={shotgunLogo}
              alt="Shotgun App"
              className="w-20 h-20 rounded-xl shadow-glow"
            />
          </div>
        ...
        <div className="flex justify-center items-center space-x-3 mb-8">
          {[1, 2, 3, 4].map((step) => {
            ...
            const isActive =
              ...
              (step === 3 && (currentStep === 3 || currentStep === 4));
        ...
        {currentStep === 5 && (
          <Card className="step-card active">
            <div className="text-center space-y-6">
              ...
              <p className="body-regular">
                Try and spin the jogwheel to discover if you've won!
              </p>

              <LotteryWheel result={wheelResult} lottieRef={playerRef} />

              {spinError && (
                <div className="mt-4 p-2 bg-destructive/10 border border-destructive/20 rounded-lg">
                  <p className="text-destructive text-sm font-grotesk">
                    {spinError}
                  </p>
                </div>
              )}
